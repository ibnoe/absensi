...
JOIN unit_organisasi d ON d.id = c.unit_bagian
...
WHERE UNIX_TIMESTAMP(DATE_FORMAT(fttime, '%Y-%m-%d')) BETWEEN UNIX_TIMESTAMP('2010-08-01') AND UNIX_TIMESTAMP('2010-08-20')
AND d.id = 'BL.012'
